...
| release plan / final manifest contract | [`release docs`](../release/README.md)、[`validators`](../../scripts/release) | [`release contract tests`](../../scripts/tests/release-contract) | `contract-tested` | 31 项对抗测试（含 optional peer）覆盖最终 bytes/digest/inventory、SBOM/license/provenance/signature evidence 与递归 archive budget；不执行 build、签名、notarization、上传或 registry 发布。 |
