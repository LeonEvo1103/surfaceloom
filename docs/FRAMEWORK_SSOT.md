...
| `SL-P3-094` | ready | `SL-P3-091`,`SL-P3-092`,`SL-P3-093` | reference-agent E2E、入口脚本、真实报告验收与说明 | 一条命令运行 M1 四项矩阵并生成 v3 bundle；真实 browser 0 skip；报告关联 criterion、run/call、ledger/probe、完整性与 cleanup，不借私有代码入口 |
